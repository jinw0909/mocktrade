...
from utils.trei_okx import MySQLAdapter,MakeErrorType
...
@router.post('/buy_limit_order_okx', summary='ORDER_OKX', tags=['ORDER API OKX'])
async def api_select(user_no: str, symbol: str, margin_type: int, leverage: int,price:float, usdt: Optional[float] = 0, amount: Optional[float] = 0,tp: Optional[float] = 0, sl: Optional[float] = 0):
    ...
    try:
        ...
        if len(data)>0  :
            ...
            await update_position_status_per_user_okx(user_id, user_no)
            await update_order_status_per_user_okx(user_id, user_no)
            await update_balance_status_per_user_okx(user_id, user_no)
...
@router.post('/sell_limit_order_okx', summary='ORDER', tags=['ORDER API OKX'])
async def api_select(user_no: str, symbol: str, margin_type: int, leverage: int,price:float, usdt: Optional[float] = 0, amount: Optional[float] = 0,tp: Optional[float] = 0, sl: Optional[float] = 0):
...
@router.post('/buy_market_order_okx', summary='ORDER', tags=['ORDER API OKX'])
...
@router.post('/sell_market_order_okx', summary='ORDER', tags=['ORDER API OKX'])
async def api_select(user_no: str, symbol: str, margin_type: int, leverage: int, usdt: Optional[float] = 0, amount: Optional[float] = 0,tp: Optional[float] = 0, sl: Optional[float] = 0):
...
@router.post('/cancle_order_okx', summary='ORDER', tags=['ORDER API OKX'])
...
@router.post('/all_cancle_order_okx', summary='ORDER', tags=['ORDER API OKX'])
...
@router.post('/close_position_okx', summary='CLOSE POSITION', tags=['ORDER API OKX'])
...
@router.post('/all_close_position_okx', summary='ALL_CLOSE POSITION', tags=['ORDER API OKX'])
...
@router.post('/position_tp_sl_okx', summary='POSITION TP SL', tags=['ORDER API OKX'])
...
@router.get('/liq_price_okx', summary='LIQ', tags=['ORDER API OKX'])
